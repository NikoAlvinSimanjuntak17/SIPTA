		...
		if ($this->form_validation->run()) {
			...
			if ($save_kategori) {
				if ($this->input->post('save_type') == 'stay') {
					...
					$this->data['message'] = 'Data telah berhasil disimpan. '.anchor('administrator/kategori/edit/' . $save_kategori, 'Edit Kategori').' or  '.anchor('administrator/kategori', ' Go back to list');
				} else {
					set_message('Data telah berhasil disimpan. '.anchor('administrator/kategori/edit/' . $save_kategori, 'Edit Kategori'), 'success');
		...
		if ($this->form_validation->run()) {
			...
			if ($save_kategori) {
				if ($this->input->post('save_type') == 'stay') {
					$this->data['success'] = true;
					$this->data['id'] 	   = $id;
					$this->data['message'] = 'Data telah berhasil diperbarui. '.anchor('administrator/kategori', ' Go back to list');
				} else {
