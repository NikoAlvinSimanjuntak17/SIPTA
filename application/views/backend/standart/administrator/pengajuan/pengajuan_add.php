...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class=""><a  href="<?= site_url('administrator/pengajuan'); ?>">Peminjaman</a></li>
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open('', [
                            ...
                            <select  class="form-control chosen chosen-select-deselect" name="nama_barang" id="nama_barang" data-placeholder="Pilih Nama Barang">
                                    <option value=""></option>
                                    <?php
                                    // Fetch only items with status 'tersedia'
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Peminjam" value="<?= set_value('nama'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            ...
            text: "Data peminjaman yang sudah dibuat, akan terbuang sia-sia.",
            type: "warning",
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/pengajuan';
            }
          });
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/pengajuan/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
