            ...
            <div class="box box-primary">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/pengajuan/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_pengajuan', 
                        ...
                        <div class="form-group ">
                            <label for="nama" class="col-sm-2 control-label">Nama Peminjam
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            ...
            text: "Data peminjaman yang akan diubah, akan tereset kembali.",
            type: "warning",
