            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="add new Form (Ctrl+a)" href="<?=  site_url('administrator/form/add'); ?>"><i class="fa fa-plus-square-o" ></i> Add New Form</a>
                        <?php }) ?>
                                                <?php is_allowed('form_export', function(){?>
                        <a class="btn btn-flat btn-success" title="export Form" href="<?= site_url('administrator/form/export'); ?>"><i class="fa fa-file-excel-o" ></i> Export</a>
                        <?php }) ?>
                     </div>
                     ...
                     <?php foreach($forms as $form): ?>
                        <tr>
                           ...
                           <td width="280">
                              ...
                              <a href="<?= site_url('administrator/form_' . str_replace('-', '_', url_title(strtolower($form->subject))) ); ?>" class="label-default"><i class="fa fa-bars"></i> Manage</a>
                              <?php }) ?>
                              <?php is_allowed('form_view', function($option_form) use ($form){?>
                              <a href="<?= site_url('administrator/form/view/'.$form->id); ?>" class="label-default"><i class="fa fa-newspaper-o"></i> View
                              <?php }) ?>
                               <?php is_allowed('form_update', function($option_form) use ($form){?>
                              <a href="<?= site_url('administrator/form/edit/' . $form->id); ?>" class="label-default"><i class="fa fa-edit "></i> Update</a>
                              <?php }) ?>
                              <?php is_allowed('form_delete', function($option_form) use ($form){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/form/delete/' . $form->id); ?>" class="label-default remove-data"><i class="fa fa-close"></i> Remove</a>
                               <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/form');?>" title="reset filters">
