                        ...
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <small class="info help-block">
                                                ...
                                                <div class="form-group ">
                            <label for="sn" class="col-sm-2 control-label">Serial Number 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="sn" id="sn" placeholder="Serial Number" value="<?= set_value('sn'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            ...
            text: "Data barang yang sudah dibuat, akan terbuang sia-sia.",
            type: "warning",
