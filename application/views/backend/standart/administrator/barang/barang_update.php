...
<section class="content">
                        ...
                        <?= form_open(base_url('administrator/barang/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                ...
                                <small class="info help-block">
                                                ...
                                                <div class="form-group ">
                            <label for="sn" class="col-sm-2 control-label">SN 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="sn" id="sn" placeholder="Serial Number" value="<?= set_value('sn', $barang->sn); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
    ...
    <div class="col-sm-8">
        <select class="form-control chosen chosen-select-deselect" name="status" id="status" data-placeholder="Pilih Status">
            <option value=""></option>
            <?php 
            // Daftar opsi status
            $statuses = ['tersedia', 'penempatan', 'peminjaman', 'kerusakan', 'mutasi'];
            
            // Loop untuk membuat dropdown
            foreach ($statuses as $status): ?>
                <option <?= $status == $barang->status ? 'selected' : ''; ?> value="<?= $status; ?>">
                    <?= ucwords($status); ?>
                </option>
            <?php endforeach; ?>
        </select>
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            ...
            text: "Data barang yang akan diubah, akan tereset kembali.",
            type: "warning",
