...
<section class="content">
    ...
    <div class="col-sm-8">
        <textarea class="form-control" name="keterangan" id="keterangan" placeholder="Masukkan keterangan"><?= set_value('keterangan'); ?></textarea>
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            ...
            text: "Data lokasi yang sudah dibuat, akan terbuang sia-sia.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/lokasi/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
