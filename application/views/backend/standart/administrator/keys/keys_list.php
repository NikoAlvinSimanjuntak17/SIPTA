            ...
            <div class="box-body ">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                      <?php is_allowed('keys_add', function(){?>
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="add new Keys (Ctrl+a)" href="<?=  site_url('administrator/keys/add'); ?>"><i class="fa fa-plus-square-o" ></i> Add New API Keys</a>
                        <?php }) ?>
                      <?php is_allowed('keys_export', function(){?>
                        <a class="btn btn-flat btn-success" title="export Keys" href="<?= site_url('administrator/keys/export'); ?>"><i class="fa fa-file-excel-o" ></i> Export</a>
                        <?php }) ?>
                        <?php is_allowed('keys_export', function(){?>
                        <a class="btn btn-flat btn-success" title="export pdf keys" href="<?= site_url('administrator/keys/export_pdf'); ?>"><i class="fa fa-file-pdf-o" ></i> Export PDF</a>
                        <?php }) ?>
                     </div>
                     ...
                     <?php foreach($keyss as $keys): ?>
                        <tr>
                           ...
                           <td width="200">
                              ...
                              <a href="<?= site_url('administrator/keys/view/' . $keys->id); ?>" class="label-default"><i class="fa fa-newspaper-o"></i> View
                              <?php }) ?>
                              <?php is_allowed('keys_update', function($option_keys) use ($keys){?>
                              <a href="<?= site_url('administrator/keys/edit/' . $keys->id); ?>" class="label-default"><i class="fa fa-edit "></i> Update</a>
                              <?php }) ?>
                              <?php is_allowed('keys_delete', function($option_keys) use ($keys){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/keys/delete/' . $keys->id); ?>" class="label-default remove-data"><i class="fa fa-close"></i> Remove</a>
                               <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/keys');?>" title="reset filters">
