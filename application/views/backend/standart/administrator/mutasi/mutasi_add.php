                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open('', [
                            ...
                            <label for="id_lok" class="col-sm-2 control-label">Lokasi Awal
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            ...
            text: "Data mutasi yang sudah dibuat, akan terbuang sia-sia.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/mutasi/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
