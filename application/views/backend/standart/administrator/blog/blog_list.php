            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="add new Blog (Ctrl+a)" href="<?=  site_url('administrator/blog/add'); ?>"><i class="fa fa-plus-square-o" ></i> Add New Blog</a>
                        <?php }) ?>
                        <?php is_allowed('blog_export', function(){?>
                        <a class="btn btn-flat btn-success" title="export Blog" href="<?= site_url('administrator/blog/export'); ?>"><i class="fa fa-file-excel-o" ></i> Export XLS</a>
                        <?php }) ?>
                        <?php is_allowed('blog_export', function(){?>
                        <a class="btn btn-flat btn-success" title="export pdf Blog" href="<?= site_url('administrator/blog/export_pdf'); ?>"><i class="fa fa-file-pdf-o" ></i> Export PDF</a>
                        <?php }) ?>
                     </div>
                     ...
                     <?php foreach($blogs as $blog): ?>
                        <tr>
                           ...
                           <td width="200">
                              ...
                              <a href="<?= site_url('administrator/blog/view/' . $blog->id); ?>" class="label-default"><i class="fa fa-newspaper-o"></i> View
                              <?php }) ?>
                              <?php is_allowed('blog_update', function($option_blog) use ($blog){?>
                              <a href="<?= site_url('administrator/blog/edit/' . $blog->id); ?>" class="label-default"><i class="fa fa-edit "></i> Update</a>
                              <?php }) ?>
                              <?php is_allowed('blog_delete', function($option_blog) use ($blog){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/blog/delete/' . $blog->id); ?>" class="label-default remove-data"><i class="fa fa-close"></i> Remove</a>
                               <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/blog');?>" title="reset filters">
