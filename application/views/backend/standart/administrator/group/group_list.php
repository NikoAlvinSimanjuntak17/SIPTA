            ...
            <div class="box-body ">
                     ...
                     <?php foreach($groups as $group): ?>
                        <tr>
                           ...
                           <td width="200">
                              ...
                              <a href="<?= site_url('administrator/group/view/' . $group->id); ?>" class="label-default"><i class="fa fa-newspaper-o"></i> Lihat
                              <?php }) ?>

                              <?php is_allowed('group_update', function($option_group) use ($group){?>
                              <a href="<?= site_url('administrator/group/edit/' . $group->id); ?>" class="label-default"><i class="fa fa-edit "></i> Edit</a>
                              <?php }) ?>

                              <?php is_allowed('group_delete', function($option_group) use ($group){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/group/delete/' . $group->id); ?>" class="label-default remove-data"><i class="fa fa-close"></i> Hapus</a>
                              <?php }) ?>
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/group'); ?>" title="reset filter">
