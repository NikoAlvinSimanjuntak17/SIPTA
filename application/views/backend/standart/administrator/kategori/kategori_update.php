...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class=""><a  href="<?= site_url('administrator/kategori'); ?>">Kategori</a></li>
            ...
            <div class="box box-primary">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/kategori/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_kategori', 
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            ...
            text: "Data kategori yang akan diubah, akan tereset kembali.",
            type: "warning",
