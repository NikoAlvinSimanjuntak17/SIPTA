...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class=""><a  href="<?= site_url('administrator/form_pengajuan_pinjam_barang'); ?>">Pengajuan Pinjam Barang</a></li>
            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/form_pengajuan_pinjam_barang/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <label for="nipp" class="col-sm-2 control-label">NIPP 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="nipp" id="nipp" data-placeholder="Select NIPP"  >
                                    <option value=""></option>
                                    <?php foreach (db_get_all_data('karyawan') as $row): ?>
                                    <option <?=  $row->nik ==  $form_pengajuan_pinjam_barang->nipp ? 'selected' : ''; ?> value="<?= $row->nik ?>"><?= $row->nik; ?></option>
                                    <?php endforeach; ?>  
                                </select>
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/form_pengajuan_pinjam_barang';
            }
          });
