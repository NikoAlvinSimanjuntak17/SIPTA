...
<section class="content-header">
   <h1>
      Data Karyawan<small>List All</small>
   </h1>
   <ol class="breadcrumb">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="add new Karyawan (Ctrl+a)" href="<?=  site_url('administrator/karyawan/add'); ?>"><i class="fa fa-plus-square-o" ></i> Add New Data Karyawan</a>
                        <?php }) ?>
                     ...
                     <h5 class="widget-user-desc">List All Data Karyawan <i class="label bg-yellow"><?= $karyawan_counts; ?>  items</i></h5>
                  </div>
                  ...
                  <table class="table table-bordered table-striped dataTable">
                     ...
                     <?php foreach($karyawans as $karyawan): ?>
                      ...
                      <?php if ($karyawan_counts == 0) :?>
                         <tr>
                           <td colspan="100">
                           Data Karyawan data is not available
                           </td>
                         </tr>
                      <?php endif; ?>
                     </tbody>
