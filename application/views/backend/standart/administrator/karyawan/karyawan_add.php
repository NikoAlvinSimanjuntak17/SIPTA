...
<section class="content-header">
    <h1>
        Data Karyawan        <small>New Data Karyawan</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class=""><a  href="<?= site_url('administrator/karyawan'); ?>">Data Karyawan</a></li>
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Data Karyawan</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_karyawan', 
                            ...
                            <div class="col-sm-8">
                                ...
                                <small class="info help-block">
                                                ...
                                                <div class="form-group ">
                            <label for="nik" class="col-sm-2 control-label">NIPP 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="nik" id="nik" placeholder="NIPP" value="<?= set_value('nik'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/karyawan';
            }
          });
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/karyawan/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
