                  ...
                  <?= form_open(base_url('administrator/user/edit_save/'.$this->uri->segment(4)), [
                   ...
                   <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                          ...
                          <small class="info help-block">Masukkan username kamu!</small>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                          ...
                          <small class="info help-block">Masukkan email kamu!</small>
                        </div>
                    </div>
   ...
   $(document).ready(function() {
    $('#btn_cancel').click(function() {
        swal({
                ...
                text: "Data pengguna yang akan diubah, akan tereset kembali.",
                type: "warning",
