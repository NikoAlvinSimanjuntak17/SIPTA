               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <?= form_open('', [
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <select  class="form-control chosen chosen-select" name="group[]" id="group" tabi-ndex="5" multiple data-placeholder="Pilih Roles">
  ...
  $(document).ready(function() {
    $('#btn_cancel').click(function() {
        swal({
                ...
                text: "Data pengguna yang sudah dibuat, akan terbuang sia-sia.",
                type: "warning",
