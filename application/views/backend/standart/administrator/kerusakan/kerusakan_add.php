...
<section class="content-header">
    <h1>
        kerusakan        <small>kerusakan Baru</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">kerusakan Baru</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_kerusakan', 
                            ...
                            <select class="form-control chosen chosen-select-deselect" name="nama_barang" id="nama_barang" data-placeholder="Pilih Nama Barang">
                                <option value=""></option>
                                <?php 
                                    $available_items = db_get_all_data('barang', ['status' => 'tersedia']); 
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Penanggung Jawab" value="<?= set_value('nama'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="departemen" id="departemen" data-placeholder="Pilih Departemen Penanggung Jawab" >
                                    <option value=""></option>
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="tanggal_kerusakan"  placeholder="Tanggal kerusakan" id="tanggal_kerusakan">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            title: "Batalkan pembuatan kerusakan?",
            text: "Data kerusakan yang sudah dibuat, akan terbuang sia-sia.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/kerusakan/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
