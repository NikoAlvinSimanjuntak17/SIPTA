...
<section class="content-header">
    <h1>
        kerusakan        <small>Edit kerusakan</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit kerusakan</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/kerusakan/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_kerusakan', 
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="nama_barang" id="nama_barang" data-placeholder="Pilih Nama Barang" >
                                    ...
                                    <option <?=  $row->nama_barang ==  $kerusakan->nama_barang ? 'selected' : ''; ?> value="<?= $row->nama_barang ?>"><?= $row->nama_barang; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="departemen" id="departemen" data-placeholder="Pilih Departemen" >
                                    ...
                                    <option <?=  $row->nama_departemen ==  $kerusakan->departemen ? 'selected' : ''; ?> value="<?= $row->nama_departemen ?>"><?= $row->nama_departemen; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="lokasi" id="lokasi" data-placeholder="Pilih Lokasi" >
                                    ...
                                    <option <?=  $row->nama_lokasi ==  $kerusakan->lokasi ? 'selected' : ''; ?> value="<?= $row->nama_lokasi ?>"><?= $row->nama_lokasi; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="jumlah" id="jumlah" placeholder="Jumlah" value="<?= set_value('jumlah', $kerusakan->jumlah); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                                                ...
                                                <div class="form-group ">
                            <label for="tanggal_kerusakan" class="col-sm-2 control-label">Tanggal kerusakan 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="tanggal_kerusakan"  placeholder="Tanggal kerusakan" id="tanggal_kerusakan" value="<?= set_value('kerusakan_tanggal_kerusakan_name', $kerusakan->tanggal_kerusakan); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="keterangan" name="keterangan" rows="10" cols="80"> <?= set_value('keterangan', $kerusakan->keterangan); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            title: "Batalkan edit kerusakan?",
            text: "Data kerusakan yang akan diubah, akan tereset kembali.",
            type: "warning",
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/kerusakan';
            }
          });
      ...
      $('.btn_save').click(function(){
        ...
        var form_kerusakan = $('#form_kerusakan');
        var data_post = form_kerusakan.serializeArray();
        ...
        $.ajax({
          url: form_kerusakan.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#kerusakan_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
