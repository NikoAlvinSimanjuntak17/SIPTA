...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class=""><a  href="<?= site_url('administrator/retur'); ?>">Pengembalian</a></li>
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open('', [
                            ...
                            <select class="form-control chosen chosen-select-deselect" name="nama_barang" id="nama_barang" data-placeholder="Pilih Nama Barang">
                                <option value=""></option>
                                <?php 
                                // Mengambil barang yang statusnya selain "tersedia"
                                $barang = db_get_all_data('barang', ['status !=' => 'tersedia']);
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            ...
            text: "Data Pengembalian yang sudah dibuat, akan terbuang sia-sia.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
       ...
       $('#retur_berkas_galery').fineUploader({
          ...
          request: {
              endpoint: BASE_URL + '/administrator/retur/upload_berkas_file',
              params : params
          },
          deleteFile: {
              enabled: true, 
              endpoint: BASE_URL + '/administrator/retur/delete_berkas_file',
          },
          thumbnails: {
              placeholders: {
          ...
          callbacks: {
              ...
              onSubmit : function(id, name) {
                  ...
                  $.get(BASE_URL + '/administrator/retur/delete_berkas_file/' + uuid);
              },
