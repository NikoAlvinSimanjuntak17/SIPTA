            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="Tambah Retur baru (Ctrl+A)" href="<?=  site_url('administrator/retur/add'); ?>"><i class="fa fa-plus-square-o" ></i> Tambah Pengembalian Baru</a>
                        <?php }) ?>
                        <?php is_allowed('retur_export', function(){?>
                        <a class="btn btn-flat btn-success" title="Export Retur dalam format XLS" href="<?= site_url('administrator/retur/export'); ?>"><i class="fa fa-file-excel-o" ></i> Export XLS</a>
                        <?php }) ?>
                        <?php is_allowed('retur_export', function(){?>
                        <a class="btn btn-flat btn-success" title="Export Retur dalam format PDF" href="<?= site_url('administrator/retur/export_pdf'); ?>"><i class="fa fa-file-pdf-o" ></i> Export PDF</a>
                        <?php }) ?>
                     </div>
                     ...
                     <h5 class="widget-user-desc">Total : <i class="label bg-blue"><?= $retur_counts; ?>  Pengembalian</i></h5>
                  </div>
                     ...
                     <?php foreach($returs as $retur): ?>
                        <tr>
                           ...
                           <td width="200">
                              ...
                              <a href="<?= site_url('administrator/retur/view/' . $retur->id_retur); ?>" class="label-default"><i class="fa fa-newspaper-o"></i> Lihat
                              <?php }) ?>
                              <?php is_allowed('retur_update', function($option_retur) use ($retur){?>
                              <a href="<?= site_url('administrator/retur/edit/' . $retur->id_retur); ?>" class="label-default"><i class="fa fa-edit "></i> Edit</a>
                              <?php }) ?>
                              <?php is_allowed('retur_delete', function($option_retur) use ($retur){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/retur/delete/' . $retur->id_retur); ?>" class="label-default remove-data"><i class="fa fa-close"></i> Hapus</a>
                               <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/retur');?>" title="reset filter">
    ...
    $('#apply').click(function(){
      ...
      if (bulk.val() == 'delete') {
         swal({
            ...
            text: "Retur yang sudah dihapus, tidak dapat dikembalikan lagi!",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
