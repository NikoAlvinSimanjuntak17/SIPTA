            ...
            <div class="box box-primary">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group">
    <label for="nama_barang" class="col-sm-2 control-label">Nama Barang <i class="required">*</i></label>
    <div class="col-sm-8">
        <select class="form-control chosen chosen-select-deselect" 
                name="nama_barang[]" 
                id="nama_barang" 
                multiple="multiple" 
                data-placeholder="Pilih Nama Barang atau SN">
            <option value=""></option>
            <?php foreach ($barang_unused as $row): ?>
            <option value="<?= $row->nama_barang ?>"><?= $row->nama_barang; ?> - <?= $row->sn; ?></option>
            <?php endforeach; ?>
        </select>
        <small class="info help-block">Pilih satu atau lebih barang berdasarkan Nama Barang atau SN.</small>
    </div>
</div>
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            ...
            text: "Data pengadaan yang sudah dibuat, akan terbuang sia-sia.",
            type: "warning",
