               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="form-horizontal" name="form_penempatan" id="form_penempatan" >
                    ...
                    <div class="view-nav">
                        ...
                        <a class="btn btn-flat btn-info btn_edit btn_action" id="btn_edit" data-stype='back' title="Edit penempatan (Ctrl+E)" href="<?= site_url('administrator/penempatan/edit/'.$penempatan->id_penempatan); ?>"><i class="fa fa-edit" ></i> Edit Penempatan</a>
                        <?php }) ?>
                        <a class="btn btn-flat btn-default btn_action" id="btn_back" title="Kembali (Ctrl+X)" href="<?= site_url('administrator/penempatan/'); ?>"><i class="fa fa-undo" ></i> Kembali ke Daftar</a>
                     </div>
