...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class=""><a  href="<?= site_url('administrator/jenis_pengadaan'); ?>">Jenis Pengadaan</a></li>
            ...
            <div class="box box-primary">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/jenis_pengadaan/edit_save/'.$this->uri->segment(4)), [
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            ...
            text: "Data jenis pengadaan yang akan diubah, akan tereset kembali.",
            type: "warning",
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/jenis_pengadaan';
            }
          });
