...
<nav id="mainNav" class="navbar navbar-default navbar-fixed-top"  style="border-radius:30px;  padding: 5px 10px; margin: 15px 65px;">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <img src="<?=BASE_ASSET;?>img/logo-pelindo.png" width="130px">
